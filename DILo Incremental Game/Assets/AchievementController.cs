...
public class AchievementController : MonoBehaviour
{
    ...
    // untuk memudahkan pemanggilan scipt yang bersifat manager dar script lain
    ...
    private void Update()
    {
        if (_popUpShowDurationCounter > 0)
        {
            ...
            // Lerp adalah fungsi interpolation, digunakan untuk mengubah value secara perlahan
...
// dan bisa diinputkan dari inspector, jika tidak terdapat ini, maka variabel tidak akan muncul di inspector
